...
from electrumpq.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
...
class SendScreen(CScreen):
    ...
    def do_save(self):
        ...
        from electrumpq.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrumpq.util import create_URI
