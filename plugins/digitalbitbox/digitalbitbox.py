...
try:
    import electrumpq
    from electrumpq.bitcoin import TYPE_ADDRESS, push_script, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    from electrumpq.bitcoin import serialize_xpub, deserialize_xpub
    from electrum import constants
    from electrumpq.transaction import Transaction
    from electrumpq.i18n import _
    from electrumpq.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrumpq.util import print_error, to_string, UserCancelled
    from electrumpq.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
